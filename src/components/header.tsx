...
export const Header = () => {
  ...
  return (
    <motion.header
      ...
      className="sticky top-5 z-20 my-5 flex items-center gap-2 sm:top-10 sm:my-10 sm:rounded-full sm:border sm:bg-background/80 sm:px-2 sm:py-3 sm:backdrop-blur-sm"
    >
      ...
      <ThemeToggle className="bg-background/60 backdrop-blur-sm sm:hidden" />
